        ...
        <div className="wrap tab-hero-grid">
          <div className="tab-hero-copy">
            ...
            <div className="hero-actions">
              {c.social.instagram
                ? <a href={c.social.instagram} target="_blank" rel="noopener" className="btn btn-primary">{p.ctaLabel || 'Work with me'} &rarr;</a>
                : (c.site.email ? <EmailButton email={c.site.email} subject={`${p.title} inquiry`} className="btn btn-primary" label={p.ctaLabel || 'Book me'} /> : null)}
            </div>
          </div>
          {p.videoId ? (
      ...
      <section className="tab-cta">
        <div className="wrap">
          ...
          <div className="hero-actions" style={{ justifyContent: 'center', marginTop: 20 }}>
            {c.social.instagram ? <a href={c.social.instagram} target="_blank" rel="noopener" className="btn btn-primary">DM on Instagram &rarr;</a> : null}
            {c.site.email ? <EmailButton email={c.site.email} subject={`${p.title} inquiry`} className="btn btn-ghost" label="Email me" /> : null}
          </div>
        </div>
      </section>
    </>

...
export async function generateMetadata() {
  ...
  return { title: `${p.title} — ${c.site.brand}`, description: p.paragraphs[0], alternates: { canonical: `https://${c.site.domain}/about` } };
}
            ...
            <Reveal>
              <div className="video-panel">
                <div className="vp-copy">
                  ...
                  <p>A quick hello, straight from me. Hit play and get a feel for who you'd be working with.</p>
                ...
                <Short id={p.videoId} title="About" />
              </div>
            </Reveal>
          </div>
        </section>

...
const GROUPS = [
  ...
  { title: 'Featured promo links', fields: [
    { label: 'Offer button link', path: 'pages.about.guide.ctaHref', type: 'url' },
    { label: 'Partner button link', path: 'pages.about.partner.ctaHref', type: 'url' },
  ] },
...
export default function Quick() {
  ...
  return (
    <div className="q">
      <style>{CSS}</style>
      <div className="qbar">
        <div className="qbrand">BRANDY<span>.</span>BANKS <small>quick edits</small></div>
